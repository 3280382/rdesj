function MetaNode(model, img, wrapper) {
    ...
    this.titleInput = Toolkit.newElement("<input type=\"text\" id=\"titleInput\">");
    this.titleInput.style.display = "none";
	// action input   by Ray
    this.actionInput = Toolkit.newElement("<input type=\"text\" name=\"action\">");
	this.actionInput.style.display = "none";
	this.label=Toolkit.newElement("<label>");
	this.label.innerText=" Action ";
	//<<<
	...
	//
    this.titleInputCell.appendChild(this.label);
	this.titleInputCell.appendChild(this.actionInput);
...
MetaNode.prototype.stopEdit = function () {
	...
	//set action
    //this.getModel().setAction(this.actionInput.value);
	//this.getModel().setAction("com.sun.pp.class");
