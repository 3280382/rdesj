/** 
 * @(#)AuthoritySearchFormValidator.java 1.0.0 2011-3-3 11:02:45  
 *  
 * Copyright 2011 CTIT Co.,Ltd.  All rights reserved. 
 * CTIT PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.   
 */
package com.cicl.frame.security.authority.web.validator;
...
@Component
public class AuthoritySearchFormValidator extends AbstractMessageAwareValidator {

	private static final String VALIDATION_TEXT_PREFIX = null;

	public AuthoritySearchFormValidator() {
		super();
	}
	...
	public boolean supports(Class clazz) {
		return AuthoritySearchForm.class.isAssignableFrom(clazz);
	}
