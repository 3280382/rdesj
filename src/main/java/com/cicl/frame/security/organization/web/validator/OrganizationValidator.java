/** 
 * @(#)OrganizationValidator.java 1.0.0 2011-3-3 11:02:45  
 *  
 ...
 */
@Component
public class OrganizationValidator extends AbstractMessageAwareValidator {
	@Autowired
	...
	public void validate(Object target, Errors errors) {
		Organization entity = (Organization) target;
