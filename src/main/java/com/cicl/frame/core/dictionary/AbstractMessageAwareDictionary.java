 ...
 */
public abstract class AbstractMessageAwareDictionary extends AbstractDictionary<String, String> implements MessageSourceAware{
	@Autowired
	...
	public AbstractMessageAwareDictionary(){
		init();
	}
