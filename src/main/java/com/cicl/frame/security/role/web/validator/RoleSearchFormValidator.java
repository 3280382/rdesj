/** 
 * @(#)RoleSearchFormValidator.java 1.0.0 2011-3-3 11:02:45  
 *  
...
@Component
public class RoleSearchFormValidator extends AbstractMessageAwareValidator {

	private static final String VALIDATION_TEXT_PREFIX = null;

	public RoleSearchFormValidator() {
		super();
	}
	...
	public boolean supports(Class clazz) {
		return RoleSearchForm.class.isAssignableFrom(clazz);
	}
