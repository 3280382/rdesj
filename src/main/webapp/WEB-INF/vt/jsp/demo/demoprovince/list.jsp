...
$(function(){
	...
	grid.gridview({
		...
		colModel:[
			...
			{name:"name",display:"<fmt:message key="demoProvince.name" />",width:250},
			{name:"createdDate",display:"<fmt:message key="demoProvince.createdDate" />",width:90}			
		],
		height:"250px",
		sortname:"id",
		sortorder:"desc",
...
function loadDetail(rowid)
{
	...
	$.getJSON("load.json",{id:id}, function(data){		
		$("#fmDetailDiv").setFormValue(data.demoProvince);
	});	
}
</script>
</head>
...
<div class="contentDiv">
		...
		<div id="fmDetailDiv">
		    <table class="editTB">
		    	<tr>
				<th style="width:70px;"><fmt:message key="demoProvince.id" /></th>
				<td style="width:140px;"><input type="text" name="id" id="id" /></td>
				<th style="width:70px;"><fmt:message key="demoProvince.name" /></th>
				</tr>
			</table>
		</div>
		</li>
