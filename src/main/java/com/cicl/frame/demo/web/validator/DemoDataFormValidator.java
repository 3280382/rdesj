/** 
 * @(#)DemoDataFormValidator.java 1.0.0 2011-3-3 11:02:45  
 *  
...
@Component
public class DemoDataFormValidator extends AbstractMessageAwareValidator {

	private static final String VALIDATION_TEXT_PREFIX = null;

	public DemoDataFormValidator() {
