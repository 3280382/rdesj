 ...
 */
public abstract class AbstractDictionaryList<ID extends Serializable, TEXT extends Serializable> implements DictionaryList<ID, TEXT>{
	protected Map<ID,TEXT> map = null;
	
	public AbstractDictionaryList(){
		init();
	}
