 ...
 */
@Transactional
public abstract class AbstractCrudService<T extends Persistable, PK extends Serializable> implements
	...
	public PK save(T instance, String opType) {	
		auditLogService.saveAudit(instance, opType);
		return getIBaseCrudRepository().save(instance);
	}
	...
	public void update(T instance, String opType) {
		auditLogService.saveAudit(instance, opType);
		getIBaseCrudRepository().update(instance);
	}
	...
	public void merge(T instance, String opType) {
		auditLogService.saveAudit(instance, opType);
		getIBaseCrudRepository().merge(instance);
	}
	...
	public void remove(PK id, String opType) {
		T instance = getIBaseCrudRepository().load(id);
		auditLogService.saveAudit(instance, opType);
	...
	public void remove(PK[] ids, String opType) {
		for (PK id : ids) {
			remove(id, opType);
		}
	}
