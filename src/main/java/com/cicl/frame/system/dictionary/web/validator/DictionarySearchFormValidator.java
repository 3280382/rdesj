/** 
 * @(#)DictionarySearchFormValidator.java 1.0.0 2011-3-3 11:02:45  
 *  
...
@Component
public class DictionarySearchFormValidator extends AbstractMessageAwareValidator {

	private static final String VALIDATION_TEXT_PREFIX = null;

	public DictionarySearchFormValidator() {
		super();
	}
	...
	public boolean supports(Class clazz) {
		return DictionarySearchForm.class.isAssignableFrom(clazz);
	}
