/** 
 * @(#)QueryParam.java 1.0.0 2011-2-14 14:34:13  
 *  
...
/**
 * Class QueryParam /** Advanced Query Parameters, can be nested unlimited.
 * Example:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * the above code will generate the sql: where (name like admin% and id > 100)
 * and not age < 30 and not creationDate > '2004-10-24')
 * 
 * Note: A QueryParam can not be nested when his model is BASIC.
 * 
 * 
 * @author Ray Li
 * @version $Revision:1.0.0, $Date: 2011-2-14 14:34:13
 */
